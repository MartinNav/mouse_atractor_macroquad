use macroquad::{prelude::{Color, Rect, Vec2}, telemetry::frame, time::get_frame_time};
...
impl PhysicalBody {
    ...
    pub fn update(&mut self,mouse_p:(f32,f32)){
        ...
        let distance =Vec2::distance(Vec2 { x: mouse_p.0, y: mouse_p.1 }, Vec2 { x: curr_loc.0, y: curr_loc.1 });
